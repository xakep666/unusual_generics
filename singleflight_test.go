...
func TestDo(t *testing.T) {
	var g unusual_generics.SingleFlightGroup[string]
...
func TestForget(t *testing.T) {
	var g unusual_generics.SingleFlightGroup[*int]
	...
	secondResult := g.DoChan("key", func() (i *int, e error) {
		<-unblockSecond
		return unusual_generics.Ptr(2), nil
	})
	...
	thirdResult := g.DoChan("key", func() (i *int, e error) {
		return unusual_generics.Ptr(3), nil
	})
...
func TestPanicDoChan(t *testing.T) {
	...
	if os.Getenv("TEST_PANIC_DOCHAN") != "" {
		...
		g := new(unusual_generics.SingleFlightGroup[int])
